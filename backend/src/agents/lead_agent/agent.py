...
def make_lead_agent(config: RunnableConfig):
    ...
    return create_agent(
        ...
        tools=get_available_tools(
            model_name=model_name, groups=agent_config.tool_groups if agent_config else None, subagent_enabled=subagent_enabled
        ),
        ...
        system_prompt=apply_prompt_template(
            ...
            available_skills=set(agent_config.skills) if agent_config and agent_config.skills else None,
        ),
        state_schema=ThreadState,
    )
